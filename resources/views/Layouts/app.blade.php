        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">{{ $company->name }}</h1>
                            <p class="text-secondary mb-0">Handcraft products</p>
                        </a>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <span class="text-light"><a href="#"><i
                                class="fas fa-copyright text-light me-2"></i>{{ $company->name }}</a>, All right
                        reserved.</span>
                </div>
